...
public class MqttConfigService {
    ...
    private String subscribe = "/fox/cloud/aggregator/request/#";

    /**
     * MQTT发布位置
     */
    @Value("${mqtt.topic.publish}")
    private String publish = "/fox/cloud/aggregator/respond";
    ...
    @Value("${mqtt.keep-alive-secs}")
    private Integer keepAliveSecs = 60;

    @Value("${mqtt.re-interval}")
