...
public class RepoProductEntityService {
    ...
    public Map<String, Object> queryProductEntityPage(Map<String, Object> body, SortBuilder sortBuilder) {
        ...
        if (!MethodUtils.hasEmpty(name)) {
            andWrapper.eq(ConstantRepoProduct.field_model, name);
        }
        ...
        if (!MethodUtils.hasEmpty(keyWords)) {
            ...
            for (String keyWord : keyWords) {
                orWrapper.like(RepoProductEntity::getModel, keyWord);
    ...
    public RepoProductEntity updateProductEntity(Map<String, Object> param) {
        ...
        if (param.containsKey(ConstantRepoProduct.field_model)) {
            updateBuilder.set(RepoProductEntity::getModel, param.get(ConstantRepoProduct.field_model));
        }
