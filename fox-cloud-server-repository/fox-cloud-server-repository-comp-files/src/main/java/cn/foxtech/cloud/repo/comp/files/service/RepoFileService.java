...
import cn.foxtech.cloud.repo.comp.files.entity.RepoJarEntity;
import cn.foxtech.cloud.repo.comp.files.entity.RepoJarInfo;
...
public class RepoFileService {
    @Autowired
    private RepoCompVerService verService;
    ...
    public void copyDependency(RepoCompEntity compEntity, String tempFileName) throws IOException, InterruptedException {
        ...
        // 复制文件
        this.copyFile(srcFile, dstDir, dstFile);
    }

    public void copyFile(String srcFile, String dstDir, String dstFile) throws IOException, InterruptedException {
    ...
    public String saveFile(RepoCompEntity compEntity, File localFile, String filePath, String fileName) throws IOException, InterruptedException {
        if (!localFile.exists()) {
            throw new ServiceException("上传文件为空");
        }
        ...
        this.copyFile(localFile.getAbsolutePath(), filePath, fileName + extName);
    ...
    private String convertJarFile(RepoCompEntity compEntity, String filePath, String fileName, String extName) throws IOException, InterruptedException {
        ...
        // 验证版本号格式：如果不符合要求，那么该转换会抛出异常
        this.verService.convertLong(jarEntity.getProperty().getVersion());
